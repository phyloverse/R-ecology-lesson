...
This is a good time to go over reading an error, and a brief introduction of how to identify your working directory `getwd()` as well as setting your working directory `setwd("/somedirectory")`.
Also, if you need to create a directory within your script `dir.create("/some_new_directory")`,
you can simply create it within a file explorer works if short on time.
